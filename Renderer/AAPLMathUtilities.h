...
/// Generate a random two-component vector with values between min and max.
...
/// Returns a float increasing exponential for nonlinear animations( usefull for animations)
