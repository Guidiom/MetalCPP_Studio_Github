...
Abstract:
Declaration of the Camera object.
*/
...
//  - Note: the CameraUniforms struct is populated lazily on demand to reduce CPU overhead

@interface Camera : NSObject
{
    // Internally generated camera uniforms used/defined by the renderer
    CameraData _uniforms;
...
@property (readonly) CameraData _uniforms;
