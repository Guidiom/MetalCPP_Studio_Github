...
inline MeshBuffer::MeshBuffer( MTL::Buffer* _Nonnull pBuffer,
                              NS::UInteger offset,
                              NS::UInteger length,
...
, m_indexCount( 0 )
, m_indexBuffer( MeshBuffer().buffer() , (NS::UInteger)0, (NS::UInteger)0)
{
                                         ...
                                         MTKTextureLoader* textureLoader)
{
    ...
    for (MDLMaterialProperty *property in propertiesWithSemantic)
    {
           ...
           property.type == MDLMaterialPropertyTypeURL)
        {
            ...
            MTL::Texture* pTexture = ( MTL::Texture*)
            ...
            pTexture = (  MTL::Texture*)[textureLoader newTextureWithContentsOfURL:property.URLValue
                                                                                   options:options
                                                                                     error:&err];
                             ...
                             MTKTextureLoader* textureLoader)
{
    ...
    textures[TextureIndexRoughness]  = createTextureFromMaterial(modelIOSubmesh.material,
    ...
    MTL::Buffer* pMetalIndexBuffer = ( MTL::Buffer*)(metalKitSubmesh.indexBuffer.buffer);
                               ...
                               NS::Error** pError)
{
    ...
    for(NSUInteger argumentIndex = 0; argumentIndex < metalKitMesh.vertexBuffers.count; argumentIndex++)
    {
        ...
        {
            MTL::Buffer* pBuffer = ( MTL::Buffer *)mtkMeshBuffer.buffer;
                              ...
                              NS::UInteger indexBufferSize)
{
    ...
    MTL::Buffer* pMetalBuffer = nullptr;
    for(auto bufferIndex : bufferIndicessUsed)
    {
        ...
        vertexBuffers.emplace_back( MeshBuffer( pMetalBuffer , offset, sectionLength, bufferIndex) );
    }

    pMetalBuffer = pDevice->newBuffer(bufferLength, MTL::ResourceStorageModeShared);
...
MTL::Texture* newTextureFromCatalog( MTL::Device* pDevice, const char* name, MTL::StorageMode storageMode, MTL::TextureUsage usage )
{
    ...
    MTKTextureLoader* textureLoader = [[MTKTextureLoader alloc] initWithDevice:(id<MTLDevice>)pDevice];
